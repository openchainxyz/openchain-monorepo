  ...
  const submitImport = () => {
    if (importData.length === 0) {
      setAlertData({
        dismissed: false,
        severity: 'warning',
        message: `Please provide some data to import`,
      });
      return;
    }
    ...
    fetch(`${apiEndpoint()}/v1/import`, {
      ...
      .then((json) => {
        ...
        let [importTable, alertMessage] = processImport(
          json['result'] as ImportResponse
        );
          ...
          >
            ...
            <Grid item xs={'auto'}>
              <ButtonGroup variant="outlined">
                ...
                <Button onClick={() => setImportData(examples.huff)}>
                  Huff
                </Button>
              </ButtonGroup>
            </Grid>
