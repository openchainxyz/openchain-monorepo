...
function processSearch(results: SignaturesResponse): React.ReactElement {
    ...
    return <Grid item xs={12} md={10} lg={8}>
...
export default function Index() {
    ...
    const doSearch = () => {
        ...
        const [method, params] = constructSearchParams(query);
        ...
        <div>
            ...
            >
                ...
                <Grid item xs={8} md={7} lg={6}>
                    <Box display="flex" justifyContent="center">
                        <TextField id="search" type="text" placeholder="Enter selectors or text to search..."
                                   fullWidth
                                   value={query}
                ...
                <Grid item xs={12}>
                    <Box display="flex" justifyContent="center">
                        <Button variant="contained" onClick={doSearch} disabled={isSearching}>Search</Button>
                    </Box>
                </Grid>
